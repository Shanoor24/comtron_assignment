...
function SideBar() {
    ...
    const initOptions = [
        {id : 1, title : "Requisitions(R)", status: false, sub_menues : [{id : 1, title : "Adding New Requisition(RA)", status : false, path: "/newPatientEntry"}, {id : 2, title : "Request Entry from Remote Order", status : false, path: "/requestEntry"}, {id : 3, title : "Fast Requisitions Entry", status : false, path: "/fastEntry"}, {id : 4, title : "Quick Assecssion Remote Order", status : false, path:"/quickAssecssion"}, {id : 5, title : "Delete a Requisition (RD)", status : false, path: "deleteRequisition"}, ]},
